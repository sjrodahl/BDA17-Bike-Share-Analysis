...
from_stations<-ggmap(seattle,extent = "normal") + geom_curve(data = trips, aes(x = from_long,y = from_lat, xend = to_long, yend = to_lat), angle = 45, color = "blue") + coord_cartesian()
