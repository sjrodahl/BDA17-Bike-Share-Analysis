...
map_curvedLines<-ggmap(seattle_impr,extent = "normal") + geom_segment(data = SumByTripsUnique, aes(x = from_long,y = from_lat, xend = to_long, yend = to_lat), alpha = SumByTripsUnique$alpha, color = "yellow")  + coord_cartesian()
